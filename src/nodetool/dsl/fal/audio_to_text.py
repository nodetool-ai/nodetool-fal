...
class NemotronAsr(SingleOutputGraphNode[dict[str, Any]], GraphNode[dict[str, Any]]):
    ...
    audio: types.AudioRef | OutputHandle[types.AudioRef] = connect_field(default=types.AudioRef(type='audio', uri='', asset_id=None, data=None, metadata=None), description='URL of the audio file.')
...
class SileroVad(SingleOutputGraphNode[dict[str, Any]], GraphNode[dict[str, Any]]):
    ...
    audio: types.AudioRef | OutputHandle[types.AudioRef] = connect_field(default=types.AudioRef(type='audio', uri='', asset_id=None, data=None, metadata=None), description='The URL of the audio to get speech timestamps from.')
