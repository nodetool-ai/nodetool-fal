...
class FfmpegApiMetadata(SingleOutputGraphNode[Any], GraphNode[Any]):
    ...
    media_url: types.VideoRef | OutputHandle[types.VideoRef] = connect_field(default=types.VideoRef(type='video', uri='', asset_id=None, data=None, metadata=None, duration=None, format=None), description='URL of the media file (video or audio) to analyze')
...
class FfmpegApiWaveform(SingleOutputGraphNode[dict[str, Any]], GraphNode[dict[str, Any]]):
    ...
    media_url: types.AudioRef | OutputHandle[types.AudioRef] = connect_field(default=types.AudioRef(type='audio', uri='', asset_id=None, data=None, metadata=None), description='URL of the audio file to analyze')
