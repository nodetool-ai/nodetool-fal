...
class Hunyuan3dV2MultiView(SingleOutputGraphNode[dict[str, Any]], GraphNode[dict[str, Any]]):
    ...
    front_image_url: types.ImageRef | OutputHandle[types.ImageRef] = connect_field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None, metadata=None), description='URL of image to use while generating the 3D model.')
    octree_resolution: int | OutputHandle[int] = connect_field(default=256, description='Octree resolution for the model.')
    back_image_url: types.ImageRef | OutputHandle[types.ImageRef] = connect_field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None, metadata=None), description='URL of image to use while generating the 3D model.')
    guidance_scale: float | OutputHandle[float] = connect_field(default=7.5, description='Guidance scale for the model.')
    num_inference_steps: int | OutputHandle[int] = connect_field(default=50, description='Number of inference steps to perform.')
    textured_mesh: bool | OutputHandle[bool] = connect_field(default=False, description='If set true, textured mesh will be generated and the price charged would be 3 times that of white mesh.')
    seed: int | OutputHandle[int] = connect_field(default=-1, description='The same seed and the same prompt given to the same version of the model will output the same image every time.')
    left_image_url: types.ImageRef | OutputHandle[types.ImageRef] = connect_field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None, metadata=None), description='URL of image to use while generating the 3D model.')
...
class Hyper3dRodin(SingleOutputGraphNode[dict[str, Any]], GraphNode[dict[str, Any]]):
    ...
    input_image_urls: list[str] | OutputHandle[list[str]] = connect_field(default=[], description='URL of images to use while generating the 3D model. Required for Image-to-3D mode. Optional for Text-to-3D mode.')
...
class Tripo3dTripoV25ImageTo3d(SingleOutputGraphNode[dict[str, Any]], GraphNode[dict[str, Any]]):
    ...
    image_url: types.ImageRef | OutputHandle[types.ImageRef] = connect_field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None, metadata=None), description='URL of the image to use for model generation.')
...
class Tripo3dTripoV25MultiviewTo3d(SingleOutputGraphNode[dict[str, Any]], GraphNode[dict[str, Any]]):
    ...
    face_limit: int | OutputHandle[int] = connect_field(default=0, description='Limits the number of faces on the output model. If this option is not set, the face limit will be adaptively determined.')
    right_image_url: types.ImageRef | OutputHandle[types.ImageRef] = connect_field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None, metadata=None), description='Right view image of the object.')
    ...
    quad: bool | OutputHandle[bool] = connect_field(default=False, description='Set True to enable quad mesh output (extra $0.05 per generation). If quad=True and face_limit is not set, the default face_limit will be 10000. Note: Enabling this option will force the output to be an FBX model.')
    front_image_url: types.ImageRef | OutputHandle[types.ImageRef] = connect_field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None, metadata=None), description='Front view image of the object.')
    texture_seed: int | OutputHandle[int] = connect_field(default=-1, description='This is the random seed for texture generation. Using the same seed will produce identical textures. This parameter is an integer and is randomly chosen if not set. If you want a model with different textures, please use same seed and different texture_seed.')
    back_image_url: types.ImageRef | OutputHandle[types.ImageRef] = connect_field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None, metadata=None), description='Back view image of the object.')
    pbr: bool | OutputHandle[bool] = connect_field(default=False, description='A boolean option to enable pbr. The default value is True, set False to get a model without pbr. If this option is set to True, texture will be ignored and used as True.')
    ...
    left_image_url: types.ImageRef | OutputHandle[types.ImageRef] = connect_field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None, metadata=None), description='Left view image of the object.')
...
class Triposr(SingleOutputGraphNode[dict[str, Any]], GraphNode[dict[str, Any]]):
    ...
    image_url: types.ImageRef | OutputHandle[types.ImageRef] = connect_field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None, metadata=None), description='Path for the image file to be processed.')
