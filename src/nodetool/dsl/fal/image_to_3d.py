...
class BytedanceSeed3DImageTo3D(
...
class Hunyuan3DV3ImageTo3D(
    ...
    PolygonType: typing.ClassVar[type] = (
        nodetool.nodes.fal.image_to_3d.Hunyuan3DV3ImageTo3D.PolygonType
    )
    ...
    polygon_type: nodetool.nodes.fal.image_to_3d.Hunyuan3DV3ImageTo3D.PolygonType = (
        Field(
            default=nodetool.nodes.fal.image_to_3d.Hunyuan3DV3ImageTo3D.PolygonType.TRIANGLE,
    ...
    generate_type: nodetool.nodes.fal.image_to_3d.Hunyuan3DV3ImageTo3D.GenerateType = (
        Field(
            default=nodetool.nodes.fal.image_to_3d.Hunyuan3DV3ImageTo3D.GenerateType.NORMAL,
...
class Hunyuan3dV2(SingleOutputGraphNode[dict[str, Any]], GraphNode[dict[str, Any]]):
    ...
    textured_mesh: bool | OutputHandle[bool] = connect_field(
        default=False,
...
class Hunyuan3dV2MultiViewTurbo(
    SingleOutputGraphNode[dict[str, Any]], GraphNode[dict[str, Any]]
):
    """
...
class Hunyuan_WorldImageToWorld(SingleOutputGraphNode[Any], GraphNode[Any]):
    ...
    classes: str | OutputHandle[str] = connect_field(
        default="", description="Classes to use for the world generation."
    )
    export_drc: bool | OutputHandle[bool] = connect_field(
        default=False,
        description="Whether to export DRC (Dynamic Resource Configuration).",
    )
    labels_fg1: str | OutputHandle[str] = connect_field(
...
class Hyper3DRodinV2(SingleOutputGraphNode[dict[str, Any]], GraphNode[dict[str, Any]]):
    ...
    QualityMeshOption: typing.ClassVar[type] = (
        nodetool.nodes.fal.image_to_3d.Hyper3DRodinV2.QualityMeshOption
    )
    GeometryFileFormat: typing.ClassVar[type] = (
        nodetool.nodes.fal.image_to_3d.Hyper3DRodinV2.GeometryFileFormat
    )
    Material: typing.ClassVar[type] = (
        nodetool.nodes.fal.image_to_3d.Hyper3DRodinV2.Material
    )

    quality_mesh_option: (
        nodetool.nodes.fal.image_to_3d.Hyper3DRodinV2.QualityMeshOption
    ) = Field(
        default=nodetool.nodes.fal.image_to_3d.Hyper3DRodinV2.QualityMeshOption.VALUE_500K_TRIANGLE,
    ...
    use_original_alpha: bool | OutputHandle[bool] = connect_field(
        default=False,
    ...
    geometry_file_format: (
        ...
        default=nodetool.nodes.fal.image_to_3d.Hyper3DRodinV2.GeometryFileFormat.GLB,
        description="Format of the geometry file. Possible values: glb, usdz, fbx, obj, stl. Default is glb.",
    )
    addons: (
        nodetool.nodes.fal.image_to_3d.Hyper3DRodinV2.Addons
        | OutputHandle[nodetool.nodes.fal.image_to_3d.Hyper3DRodinV2.Addons]
        | None
    ) = connect_field(
        default=None,
    ...
    material: nodetool.nodes.fal.image_to_3d.Hyper3DRodinV2.Material = Field(
        default=nodetool.nodes.fal.image_to_3d.Hyper3DRodinV2.Material.ALL,
...
class Hyper3dRodin(SingleOutputGraphNode[dict[str, Any]], GraphNode[dict[str, Any]]):
    ...
    ConditionMode: typing.ClassVar[type] = (
        nodetool.nodes.fal.image_to_3d.Hyper3dRodin.ConditionMode
    )
    ...
    GeometryFileFormat: typing.ClassVar[type] = (
        nodetool.nodes.fal.image_to_3d.Hyper3dRodin.GeometryFileFormat
    )
    Material: typing.ClassVar[type] = (
        nodetool.nodes.fal.image_to_3d.Hyper3dRodin.Material
    )
    ...
    condition_mode: nodetool.nodes.fal.image_to_3d.Hyper3dRodin.ConditionMode = Field(
        default=nodetool.nodes.fal.image_to_3d.Hyper3dRodin.ConditionMode.CONCAT,
    ...
    tier: nodetool.nodes.fal.image_to_3d.Hyper3dRodin.Tier = Field(
        default=nodetool.nodes.fal.image_to_3d.Hyper3dRodin.Tier.REGULAR,
        description="Tier of generation. For Rodin Sketch, set to Sketch. For Rodin Regular, set to Regular.",
    )
    quality: nodetool.nodes.fal.image_to_3d.Hyper3dRodin.Quality = Field(
        default=nodetool.nodes.fal.image_to_3d.Hyper3dRodin.Quality.MEDIUM,
    ...
    geometry_file_format: (
        ...
        default=nodetool.nodes.fal.image_to_3d.Hyper3dRodin.GeometryFileFormat.GLB,
        description="Format of the geometry file. Possible values: glb, usdz, fbx, obj, stl. Default is glb.",
    )
    use_hyper: bool | OutputHandle[bool] = connect_field(
        default=False,
        description="Whether to export the model using hyper mode. Default is false.",
    )
    addons: (
        nodetool.nodes.fal.image_to_3d.Hyper3dRodin.Addons
    ...
    material: nodetool.nodes.fal.image_to_3d.Hyper3dRodin.Material = Field(
        default=nodetool.nodes.fal.image_to_3d.Hyper3dRodin.Material.PBR,
...
class MeshyV5MultiImageTo3D(
    ...
    Topology: typing.ClassVar[type] = (
        nodetool.nodes.fal.image_to_3d.MeshyV5MultiImageTo3D.Topology
    )
    SymmetryMode: typing.ClassVar[type] = (
        nodetool.nodes.fal.image_to_3d.MeshyV5MultiImageTo3D.SymmetryMode
    )
    ...
    topology: nodetool.nodes.fal.image_to_3d.MeshyV5MultiImageTo3D.Topology = Field(
        default=nodetool.nodes.fal.image_to_3d.MeshyV5MultiImageTo3D.Topology.TRIANGLE,
    ...
    symmetry_mode: nodetool.nodes.fal.image_to_3d.MeshyV5MultiImageTo3D.SymmetryMode = (
        Field(
            default=nodetool.nodes.fal.image_to_3d.MeshyV5MultiImageTo3D.SymmetryMode.AUTO,
...
class MeshyV6PreviewImageTo3D(
    ...
    Topology: typing.ClassVar[type] = (
        nodetool.nodes.fal.image_to_3d.MeshyV6PreviewImageTo3D.Topology
    )
    SymmetryMode: typing.ClassVar[type] = (
        nodetool.nodes.fal.image_to_3d.MeshyV6PreviewImageTo3D.SymmetryMode
    )
    ...
    topology: nodetool.nodes.fal.image_to_3d.MeshyV6PreviewImageTo3D.Topology = Field(
    ...
    symmetry_mode: (
        ...
        default=nodetool.nodes.fal.image_to_3d.MeshyV6PreviewImageTo3D.SymmetryMode.AUTO,
...
class Omnipart(SingleOutputGraphNode[dict[str, Any]], GraphNode[dict[str, Any]]):
    ...
    parts: str | OutputHandle[str] = connect_field(
        default="",
    ...
    minimum_segment_size: int | OutputHandle[int] = connect_field(
...
class Sam33DBody(SingleOutputGraphNode[dict[str, Any]], GraphNode[dict[str, Any]]):
    ...
    include_3d_keypoints: bool | OutputHandle[bool] = connect_field(
        default=True,
    ...
    export_meshes: bool | OutputHandle[bool] = connect_field(
...
class Sam33DObjects(SingleOutputGraphNode[dict[str, Any]], GraphNode[dict[str, Any]]):
    ...
    export_textured_glb: bool | OutputHandle[bool] = connect_field(
        default=False,
    ...
    pointmap_url: str | OutputHandle[str] = connect_field(
        default="",
    ...
    mask_urls: list[str] | OutputHandle[list[str]] = connect_field(
        default=[],
...
class Tripo3dTripoV25ImageTo3d(
    SingleOutputGraphNode[dict[str, Any]], GraphNode[dict[str, Any]]
):
    """
    ...
    TextureAlignment: typing.ClassVar[type] = (
        nodetool.nodes.fal.image_to_3d.Tripo3dTripoV25ImageTo3d.TextureAlignment
    )
    Texture: typing.ClassVar[type] = (
        nodetool.nodes.fal.image_to_3d.Tripo3dTripoV25ImageTo3d.Texture
    )
    Orientation: typing.ClassVar[type] = (
        nodetool.nodes.fal.image_to_3d.Tripo3dTripoV25ImageTo3d.Orientation
    )

    face_limit: int | OutputHandle[int] = connect_field(
        default=0,
    ...
    style: (
        nodetool.nodes.fal.image_to_3d.Tripo3dTripoV25ImageTo3d.Style
        | OutputHandle[nodetool.nodes.fal.image_to_3d.Tripo3dTripoV25ImageTo3d.Style]
        | None
    ) = connect_field(
        default=None,
    ...
    pbr: bool | OutputHandle[bool] = connect_field(
        default=False,
    ...
    texture: nodetool.nodes.fal.image_to_3d.Tripo3dTripoV25ImageTo3d.Texture = Field(
        default=nodetool.nodes.fal.image_to_3d.Tripo3dTripoV25ImageTo3d.Texture.STANDARD,
    ...
    auto_size: bool | OutputHandle[bool] = connect_field(
        default=False,
    ...
    quad: bool | OutputHandle[bool] = connect_field(
        default=False,
    ...
    orientation: nodetool.nodes.fal.image_to_3d.Tripo3dTripoV25ImageTo3d.Orientation = (
        Field(
            default=nodetool.nodes.fal.image_to_3d.Tripo3dTripoV25ImageTo3d.Orientation.DEFAULT,
    ...
    texture_seed: int | OutputHandle[int] = connect_field(
        default=-1,
...
class Tripo3dTripoV25MultiviewTo3d(
    SingleOutputGraphNode[dict[str, Any]], GraphNode[dict[str, Any]]
):
    """
    ...
    TextureAlignment: typing.ClassVar[type] = (
        nodetool.nodes.fal.image_to_3d.Tripo3dTripoV25MultiviewTo3d.TextureAlignment
    )
    Texture: typing.ClassVar[type] = (
        nodetool.nodes.fal.image_to_3d.Tripo3dTripoV25MultiviewTo3d.Texture
    )
    Orientation: typing.ClassVar[type] = (
        nodetool.nodes.fal.image_to_3d.Tripo3dTripoV25MultiviewTo3d.Orientation
    )
    ...
    style: (
        nodetool.nodes.fal.image_to_3d.Tripo3dTripoV25MultiviewTo3d.Style
        | OutputHandle[
            nodetool.nodes.fal.image_to_3d.Tripo3dTripoV25MultiviewTo3d.Style
        ]
        | None
    ...
    texture_alignment: (
        ...
        default=nodetool.nodes.fal.image_to_3d.Tripo3dTripoV25MultiviewTo3d.TextureAlignment.ORIGINAL_IMAGE,
        description="Determines the prioritization of texture alignment in the 3D model. The default value is original_image.",
    )
    texture: nodetool.nodes.fal.image_to_3d.Tripo3dTripoV25MultiviewTo3d.Texture = (
        Field(
            default=nodetool.nodes.fal.image_to_3d.Tripo3dTripoV25MultiviewTo3d.Texture.STANDARD,
            description="An option to enable texturing. Default is 'standard', set 'no' to get a model without any textures, and set 'HD' to get a model with hd quality textures.",
        )
    )
    auto_size: bool | OutputHandle[bool] = connect_field(
...
class Triposr(SingleOutputGraphNode[dict[str, Any]], GraphNode[dict[str, Any]]):
    ...
    OutputFormat: typing.ClassVar[type] = (
        nodetool.nodes.fal.image_to_3d.Triposr.OutputFormat
    )
    ...
    do_remove_background: bool | OutputHandle[bool] = connect_field(
        default=True,
    ...
    output_format: nodetool.nodes.fal.image_to_3d.Triposr.OutputFormat = Field(
