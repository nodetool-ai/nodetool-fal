...
class AIDetectorImage(SingleOutputGraphNode[dict[str, Any]], GraphNode[dict[str, Any]]):
    ...
    image: types.ImageRef | OutputHandle[types.ImageRef] = connect_field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None, metadata=None), description='URL pointing to an image to analyze for AI generation.(Max: 3000 characters)')
...
class GotOcrV2(SingleOutputGraphNode[Any], GraphNode[Any]):
    ...
    input_images: list[str] | OutputHandle[list[str]] = connect_field(default=[], description='URL of images.')
...
class MoondreamNextBatch(SingleOutputGraphNode[dict[str, Any]], GraphNode[dict[str, Any]]):
    ...
    images_data: types.ImageRef | OutputHandle[types.ImageRef] = connect_field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None, metadata=None), description='List of image URLs to be processed (maximum 32 images)')
    max_tokens: int | OutputHandle[int] = connect_field(default=64, description='Maximum number of tokens to generate')
...
class Sa2va4bImage(SingleOutputGraphNode[dict[str, Any]], GraphNode[dict[str, Any]]):
    ...
    image: types.ImageRef | OutputHandle[types.ImageRef] = connect_field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None, metadata=None), description='Url for the Input image.')
...
class Sa2va4bVideo(SingleOutputGraphNode[dict[str, Any]], GraphNode[dict[str, Any]]):
    ...
    prompt: str | OutputHandle[str] = connect_field(default='', description='Prompt to be used for the chat completion')
    video: types.VideoRef | OutputHandle[types.VideoRef] = connect_field(default=types.VideoRef(type='video', uri='', asset_id=None, data=None, metadata=None, duration=None, format=None), description='The URL of the input video.')
...
class Sam3ImageEmbed(SingleOutputGraphNode[Any], GraphNode[Any]):
    ...
    image: types.ImageRef | OutputHandle[types.ImageRef] = connect_field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None, metadata=None), description='URL of the image to embed.')
...
class VideoUnderstanding(SingleOutputGraphNode[Any], GraphNode[Any]):
    ...
    video: types.VideoRef | OutputHandle[types.VideoRef] = connect_field(default=types.VideoRef(type='video', uri='', asset_id=None, data=None, metadata=None, duration=None, format=None), description='URL of the video to analyze')
