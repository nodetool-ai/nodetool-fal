...
class GotOcrV2(SingleOutputGraphNode[Any], GraphNode[Any]):
    ...
    do_format: bool | OutputHandle[bool] = connect_field(
...
class Moondream2ObjectDetection(
...
class Moondream2PointObjectDetection(
    SingleOutputGraphNode[dict[str, Any]], GraphNode[dict[str, Any]]
):
    """
...
class Moondream3PreviewCaption(
    SingleOutputGraphNode[dict[str, Any]], GraphNode[dict[str, Any]]
):
    """
    ...
    Length: typing.ClassVar[type] = (
        nodetool.nodes.fal.vision.Moondream3PreviewCaption.Length
    )
...
class MoondreamBatched(
    ...
    model_id: nodetool.nodes.fal.vision.MoondreamBatched.ModelId = Field(
        default=nodetool.nodes.fal.vision.MoondreamBatched.ModelId.VIKHYATK_MOONDREAM2,
...
class MoondreamNext(SingleOutputGraphNode[Any], GraphNode[Any]):
    ...
    task_type: nodetool.nodes.fal.vision.MoondreamNext.TaskType = Field(
        default=nodetool.nodes.fal.vision.MoondreamNext.TaskType.CAPTION,
...
class PerceptronIsaac01(
    ...
    ResponseStyle: typing.ClassVar[type] = (
        nodetool.nodes.fal.vision.PerceptronIsaac01.ResponseStyle
    )

    prompt: str | OutputHandle[str] = connect_field(
        default="", description="Prompt to be used for the image"
    )
    response_style: nodetool.nodes.fal.vision.PerceptronIsaac01.ResponseStyle = Field(
...
class PerceptronIsaac01OpenaiV1ChatCompletions(
...
class Sa2va4bVideo(SingleOutputGraphNode[dict[str, Any]], GraphNode[dict[str, Any]]):
    ...
    num_frames_to_sample: int | OutputHandle[int] = connect_field(
        default=0,
