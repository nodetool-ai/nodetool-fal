...
class Flux2Klein4BBaseTrainer(
    ...
    OutputLoraFormat: typing.ClassVar[type] = (
        nodetool.nodes.fal.training.Flux2Klein4BBaseTrainer.OutputLoraFormat
    )
    ...
    learning_rate: float | OutputHandle[float] = connect_field(
        default=5e-05, description="Learning rate applied to trainable parameters."
    )
    default_caption: str | OutputHandle[str] = connect_field(
        default="",
    ...
    output_lora_format: (
        ...
        default=nodetool.nodes.fal.training.Flux2Klein4BBaseTrainer.OutputLoraFormat.FAL,
...
class Flux2Klein4BBaseTrainerEdit(
    SingleOutputGraphNode[dict[str, Any]], GraphNode[dict[str, Any]]
):
    """
    ...
    OutputLoraFormat: typing.ClassVar[type] = (
        nodetool.nodes.fal.training.Flux2Klein4BBaseTrainerEdit.OutputLoraFormat
    )
    ...
    output_lora_format: (
        ...
        default=nodetool.nodes.fal.training.Flux2Klein4BBaseTrainerEdit.OutputLoraFormat.FAL,
        description="Dictates the naming scheme for the output weights",
    )
...
class Flux2Klein9BBaseTrainer(
    ...
    OutputLoraFormat: typing.ClassVar[type] = (
        nodetool.nodes.fal.training.Flux2Klein9BBaseTrainer.OutputLoraFormat
    )
    ...
    output_lora_format: (
        ...
        default=nodetool.nodes.fal.training.Flux2Klein9BBaseTrainer.OutputLoraFormat.FAL,
        description="Dictates the naming scheme for the output weights",
    )
...
class Flux2Klein9BBaseTrainerEdit(
    SingleOutputGraphNode[dict[str, Any]], GraphNode[dict[str, Any]]
):
    """
    ...
    OutputLoraFormat: typing.ClassVar[type] = (
        nodetool.nodes.fal.training.Flux2Klein9BBaseTrainerEdit.OutputLoraFormat
    )
    ...
    output_lora_format: (
        ...
        default=nodetool.nodes.fal.training.Flux2Klein9BBaseTrainerEdit.OutputLoraFormat.FAL,
        description="Dictates the naming scheme for the output weights",
    )
...
class Flux2Trainer(SingleOutputGraphNode[dict[str, Any]], GraphNode[dict[str, Any]]):
    ...
    OutputLoraFormat: typing.ClassVar[type] = (
        nodetool.nodes.fal.training.Flux2Trainer.OutputLoraFormat
    )
    ...
    output_lora_format: nodetool.nodes.fal.training.Flux2Trainer.OutputLoraFormat = (
        Field(
            default=nodetool.nodes.fal.training.Flux2Trainer.OutputLoraFormat.FAL,
            description="Dictates the naming scheme for the output weights",
        )
    )
...
class Flux2TrainerEdit(
    ...
    OutputLoraFormat: typing.ClassVar[type] = (
        nodetool.nodes.fal.training.Flux2TrainerEdit.OutputLoraFormat
    )
    ...
    output_lora_format: (
        ...
        default=nodetool.nodes.fal.training.Flux2TrainerEdit.OutputLoraFormat.FAL,
        description="Dictates the naming scheme for the output weights",
    )
...
class Flux2TrainerV2(SingleOutputGraphNode[dict[str, Any]], GraphNode[dict[str, Any]]):
    ...
    OutputLoraFormat: typing.ClassVar[type] = (
        nodetool.nodes.fal.training.Flux2TrainerV2.OutputLoraFormat
    )
    ...
    output_lora_format: nodetool.nodes.fal.training.Flux2TrainerV2.OutputLoraFormat = (
        Field(
            default=nodetool.nodes.fal.training.Flux2TrainerV2.OutputLoraFormat.FAL,
            description="Dictates the naming scheme for the output weights",
        )
    )
...
class Flux2TrainerV2Edit(
    ...
    OutputLoraFormat: typing.ClassVar[type] = (
        nodetool.nodes.fal.training.Flux2TrainerV2Edit.OutputLoraFormat
    )
    ...
    output_lora_format: (
        ...
        default=nodetool.nodes.fal.training.Flux2TrainerV2Edit.OutputLoraFormat.FAL,
        description="Dictates the naming scheme for the output weights",
    )
...
class HunyuanVideoLoraTraining(
    SingleOutputGraphNode[dict[str, Any]], GraphNode[dict[str, Any]]
):
    """
    ...
    data_archive_format: str | OutputHandle[str] = connect_field(
        default="",
    ...
    do_caption: bool | OutputHandle[bool] = connect_field(
...
class QwenImageEdit2509Trainer(
    SingleOutputGraphNode[dict[str, Any]], GraphNode[dict[str, Any]]
):
    """
...
class QwenImageEdit2511Trainer(
    SingleOutputGraphNode[dict[str, Any]], GraphNode[dict[str, Any]]
):
    """
...
class QwenImageEditPlusTrainer(
    SingleOutputGraphNode[dict[str, Any]], GraphNode[dict[str, Any]]
):
    """
...
class QwenImageTrainer(
    ...
    trigger_phrase: str | OutputHandle[str] = connect_field(
        default="",
...
class RecraftV3CreateStyle(SingleOutputGraphNode[Any], GraphNode[Any]):
    ...
    BaseStyle: typing.ClassVar[type] = (
    ...
    base_style: nodetool.nodes.fal.training.RecraftV3CreateStyle.BaseStyle = Field(
        default=nodetool.nodes.fal.training.RecraftV3CreateStyle.BaseStyle.DIGITAL_ILLUSTRATION,
...
class TurboFluxTrainer(
    ...
    TrainingStyle: typing.ClassVar[type] = (
    ...
    training_style: nodetool.nodes.fal.training.TurboFluxTrainer.TrainingStyle = Field(
        default=nodetool.nodes.fal.training.TurboFluxTrainer.TrainingStyle.SUBJECT,
        description="Training style to use.",
    )
    face_crop: bool | OutputHandle[bool] = connect_field(
        default=True,
...
class Wan22ImageTrainer(
    ...
    training_data_url: str | OutputHandle[str] = connect_field(
        default="", description="URL to the training data."
    )
    steps: int | OutputHandle[int] = connect_field(
        default=1000, description="Number of training steps."
    )
    include_synthetic_captions: bool | OutputHandle[bool] = connect_field(
        default=False, description="Whether to include synthetic captions."
    )
    is_style: bool | OutputHandle[bool] = connect_field(
        default=False,
    ...
    use_face_detection: bool | OutputHandle[bool] = connect_field(
        default=True,
...
class WanTrainer(SingleOutputGraphNode[dict[str, Any]], GraphNode[dict[str, Any]]):
    ...
    auto_scale_input: bool | OutputHandle[bool] = connect_field(
        default=False,
...
class ZImageTrainer(SingleOutputGraphNode[dict[str, Any]], GraphNode[dict[str, Any]]):
    ...
    TrainingType: typing.ClassVar[type] = (
        nodetool.nodes.fal.training.ZImageTrainer.TrainingType
    )
    ...
    training_type: nodetool.nodes.fal.training.ZImageTrainer.TrainingType = Field(
        default=nodetool.nodes.fal.training.ZImageTrainer.TrainingType.BALANCED,
