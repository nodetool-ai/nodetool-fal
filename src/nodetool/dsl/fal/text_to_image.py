...
class AuraFlowV03(GraphNode):
    ...
    expand_prompt: bool | GraphNode | tuple[GraphNode, str] = Field(
    ...
    def get_node_type(cls):
        return "fal.text_to_image.AuraFlowV03"
...
class BriaV1(GraphNode):
    ...
    prompt_enhancement: bool | GraphNode | tuple[GraphNode, str] = Field(
        default=False,
        description="When true, enhances the prompt with more descriptive variations",
    )
    medium: str | GraphNode | tuple[GraphNode, str] = Field(
    ...
    @classmethod
    def get_node_type(cls):
        return "fal.text_to_image.BriaV1"
...
class BriaV1Fast(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "fal.text_to_image.BriaV1Fast"
...
class BriaV1HD(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "fal.text_to_image.BriaV1HD"
...
class DiffusionEdge(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "fal.text_to_image.DiffusionEdge"
...
class FastLCMDiffusion(GraphNode):
    ...
    ModelNameFastLCM: typing.ClassVar[type] = (
    ...
    model_name: nodetool.nodes.fal.text_to_image.ModelNameFastLCM = Field(
        default=nodetool.nodes.fal.text_to_image.ModelNameFastLCM.SDXL_BASE,
    ...
    sync_mode: bool | GraphNode | tuple[GraphNode, str] = Field(
        default=True,
    ...
    safety_checker_version: nodetool.nodes.fal.text_to_image.SafetyCheckerVersion = (
        Field(
            default=nodetool.nodes.fal.text_to_image.SafetyCheckerVersion.V1,
    ...
    @classmethod
    def get_node_type(cls):
        return "fal.text_to_image.FastLCMDiffusion"
...
class FastLightningSDXL(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "fal.text_to_image.FastLightningSDXL"
...
class FastSDXL(GraphNode):
    ...
    loras: list[types.LoraWeight] | GraphNode | tuple[GraphNode, str] = Field(
        default=[], description="The list of LoRA weights to use"
    )

    @classmethod
    def get_node_type(cls):
        return "fal.text_to_image.FastSDXL"
...
class FastSDXLControlNetCanny(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "fal.text_to_image.FastSDXLControlNetCanny"
...
class FastTurboDiffusion(GraphNode):
    ...
    ModelNameEnum: typing.ClassVar[type] = (
    ...
    model_name: nodetool.nodes.fal.text_to_image.ModelNameEnum = Field(
        default=nodetool.nodes.fal.text_to_image.ModelNameEnum.SDXL_TURBO,
        description="The name of the model to use",
    )
    negative_prompt: str | GraphNode | tuple[GraphNode, str] = Field(
        default="",
    ...
    image_size: nodetool.nodes.fal.text_to_image.ImageSizePreset = Field(
        default=nodetool.nodes.fal.text_to_image.ImageSizePreset.SQUARE,
        description="The size of the generated image",
    )
    num_inference_steps: int | GraphNode | tuple[GraphNode, str] = Field(
    ...
    @classmethod
    def get_node_type(cls):
        return "fal.text_to_image.FastTurboDiffusion"
...
class FluxDev(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "fal.text_to_image.FluxDev"
...
class FluxDevImageToImage(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "fal.text_to_image.FluxDevImageToImage"
...
class FluxGeneral(GraphNode):
    ...
    real_cfg_scale: float | GraphNode | tuple[GraphNode, str] = Field(
        default=3.5, description="Classical CFG scale as in SD1.5, SDXL, etc."
    )
    use_real_cfg: bool | GraphNode | tuple[GraphNode, str] = Field(
        default=False,
...
class FluxLora(GraphNode):
    ...
    loras: list[types.LoraWeight] | GraphNode | tuple[GraphNode, str] = Field(
        default=[], description="List of LoRA weights to use for image generation"
    )
    seed: int | GraphNode | tuple[GraphNode, str] = Field(
        default=-1,
        description="The same seed and prompt will output the same image every time",
    ...
    @classmethod
    def get_node_type(cls):
        return "fal.text_to_image.FluxLora"
...
class FluxLoraInpainting(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "fal.text_to_image.FluxLoraInpainting"
...
class FluxLoraTTI(GraphNode):
    ...
    model_name: nodetool.nodes.fal.text_to_image.LoraModel = Field(
        default=nodetool.nodes.fal.text_to_image.LoraModel.SDXL_BASE,
    ...
    prompt_weighting: bool | GraphNode | tuple[GraphNode, str] = Field(
        default=True,
    ...
    @classmethod
    def get_node_type(cls):
        return "fal.text_to_image.FluxLoraTTI"
...
class FluxSchnell(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "fal.text_to_image.FluxSchnell"
...
class FluxSubject(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "fal.text_to_image.FluxSubject"
...
class FluxV1Pro(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "fal.text_to_image.FluxV1Pro"
...
class FluxV1ProNew(GraphNode):
    ...
    safety_tolerance: int | GraphNode | tuple[GraphNode, str] = Field(
        default=2, description="Safety tolerance level (1=strict, 6=permissive)"
    )

    @classmethod
    def get_node_type(cls):
        return "fal.text_to_image.FluxV1ProNew"
...
class FluxV1ProUltra(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "fal.text_to_image.FluxV1ProUltra"
...
class Fooocus(GraphNode):
    ...
    PerformanceEnum: typing.ClassVar[type] = (
        nodetool.nodes.fal.text_to_image.PerformanceEnum
    )
    RefinerModelEnum: typing.ClassVar[type] = (
        nodetool.nodes.fal.text_to_image.RefinerModelEnum
    )
    ControlTypeEnum: typing.ClassVar[type] = (
    ...
    styles: list[str] | GraphNode | tuple[GraphNode, str] = Field(
        default=["Fooocus Enhance", "Fooocus V2", "Fooocus Sharp"],
        description="The styles to apply to the generated image",
    )
    performance: nodetool.nodes.fal.text_to_image.PerformanceEnum = Field(
        default=nodetool.nodes.fal.text_to_image.PerformanceEnum.EXTREME_SPEED,
        description="You can choose Speed or Quality",
    )
    guidance_scale: float | GraphNode | tuple[GraphNode, str] = Field(
        default=4.0, description="How closely the model should stick to your prompt"
    )
    sharpness: float | GraphNode | tuple[GraphNode, str] = Field(
    ...
    loras: list[types.LoraWeight] | GraphNode | tuple[GraphNode, str] = Field(
        default=[], description="Up to 5 LoRAs that will be merged for generation"
    )
    refiner_model: nodetool.nodes.fal.text_to_image.RefinerModelEnum = Field(
        default=nodetool.nodes.fal.text_to_image.RefinerModelEnum.NONE,
        description="Refiner model to use (SDXL or SD 1.5)",
    )
    refiner_switch: float | GraphNode | tuple[GraphNode, str] = Field(
        default=0.8,
    ...
    control_type: nodetool.nodes.fal.text_to_image.ControlTypeEnum = Field(
        default=nodetool.nodes.fal.text_to_image.ControlTypeEnum.PYRA_CANNY,
        description="The type of image control",
    )
    control_image_weight: float | GraphNode | tuple[GraphNode, str] = Field(
        default=1.0, description="Strength of the control image influence"
    )
    control_image_stop_at: float | GraphNode | tuple[GraphNode, str] = Field(
    ...
    @classmethod
    def get_node_type(cls):
        return "fal.text_to_image.Fooocus"
...
class HyperSDXL(GraphNode):
    ...
    num_inference_steps: int | GraphNode | tuple[GraphNode, str] = Field(
        default=1, description="The number of inference steps to perform (1, 2, or 4)"
    )
    sync_mode: bool | GraphNode | tuple[GraphNode, str] = Field(
        default=True,
        description="If true, wait for image generation and upload before returning",
    ...
    @classmethod
    def get_node_type(cls):
        return "fal.text_to_image.HyperSDXL"
...
class IdeogramV2(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "fal.text_to_image.IdeogramV2"
...
class IdeogramV2Turbo(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "fal.text_to_image.IdeogramV2Turbo"
...
class LCMDiffusion(GraphNode):
    ...
    model: nodetool.nodes.fal.text_to_image.ModelNameLCM = Field(
        default=nodetool.nodes.fal.text_to_image.ModelNameLCM.SD_1_5,
    ...
    @classmethod
    def get_node_type(cls):
        return "fal.text_to_image.LCMDiffusion"
...
class LumaPhoton(GraphNode):
    ...
    AspectRatioLuma: typing.ClassVar[type] = (
        nodetool.nodes.fal.text_to_image.AspectRatioLuma
    )
    prompt: str | GraphNode | tuple[GraphNode, str] = Field(
        default="", description="The prompt to generate an image from"
    )
    aspect_ratio: nodetool.nodes.fal.text_to_image.AspectRatioLuma = Field(
        default=nodetool.nodes.fal.text_to_image.AspectRatioLuma.RATIO_1_1,
        description="The aspect ratio of the generated image",
    )

    @classmethod
    def get_node_type(cls):
        return "fal.text_to_image.LumaPhoton"
...
class LumaPhotonFlash(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "fal.text_to_image.LumaPhotonFlash"
...
class OmniGenV1(GraphNode):
    ...
    input_image_1: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(
        default=types.ImageRef(type="image", uri="", asset_id=None, data=None),
        description="The first input image to use for generation",
    )
    input_image_2: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(
        default=types.ImageRef(type="image", uri="", asset_id=None, data=None),
    ...
    @classmethod
    def get_node_type(cls):
        return "fal.text_to_image.OmniGenV1"
...
class PlaygroundV25(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "fal.text_to_image.PlaygroundV25"
...
class Recraft20B(GraphNode):
    ...
    style: nodetool.nodes.fal.text_to_image.StylePreset = Field(
        default=nodetool.nodes.fal.text_to_image.StylePreset.REALISTIC_IMAGE,
        description="The style of the generated images. Vector images cost 2X as much.",
    )
    colors: list[types.ColorRef] | GraphNode | tuple[GraphNode, str] = Field(
        default=[], description="An array of preferable colors"
    )
    style_id: str | GraphNode | tuple[GraphNode, str] = Field(
        default="", description="The ID of the custom style reference (optional)"
    )

    @classmethod
    def get_node_type(cls):
        return "fal.text_to_image.Recraft20B"
...
class RecraftV3(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "fal.text_to_image.RecraftV3"
...
class SanaV1(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "fal.text_to_image.SanaV1"
...
class StableCascade(GraphNode):
    ...
    first_stage_steps: int | GraphNode | tuple[GraphNode, str] = Field(
        default=20, description="Number of steps to run the first stage for"
    )
    second_stage_steps: int | GraphNode | tuple[GraphNode, str] = Field(
        default=10, description="Number of steps to run the second stage for"
    )
    guidance_scale: float | GraphNode | tuple[GraphNode, str] = Field(
        default=4.0, description="How closely the model should stick to your prompt"
    )
    second_stage_guidance_scale: float | GraphNode | tuple[GraphNode, str] = Field(
    ...
    @classmethod
    def get_node_type(cls):
        return "fal.text_to_image.StableCascade"
...
class StableDiffusionV35Large(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "fal.text_to_image.StableDiffusionV35Large"
...
class StableDiffusionV3Medium(GraphNode):
    ...
    prompt_expansion: bool | GraphNode | tuple[GraphNode, str] = Field(
        default=False,
    ...
    @classmethod
    def get_node_type(cls):
        return "fal.text_to_image.StableDiffusionV3Medium"
...
class Switti(GraphNode):
    ...
    sampling_top_k: int | GraphNode | tuple[GraphNode, str] = Field(
        default=400, description="The number of top-k tokens to sample from"
    )
    sampling_top_p: float | GraphNode | tuple[GraphNode, str] = Field(
        default=0.95, description="The top-p probability to sample from"
    )
    more_smooth: bool | GraphNode | tuple[GraphNode, str] = Field(
        default=True, description="Smoothing with Gumbel softmax sampling"
    )
    more_diverse: bool | GraphNode | tuple[GraphNode, str] = Field(
        default=False, description="More diverse sampling"
    )
    smooth_start_si: int | GraphNode | tuple[GraphNode, str] = Field(
        default=2, description="Smoothing starting scale"
    )
    turn_off_cfg_start_si: int | GraphNode | tuple[GraphNode, str] = Field(
        default=8, description="Disable CFG starting scale"
    )
    last_scale_temp: float | GraphNode | tuple[GraphNode, str] = Field(
    ...
    @classmethod
    def get_node_type(cls):
        return "fal.text_to_image.Switti"
