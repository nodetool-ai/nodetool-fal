...
class AceStepAudioInpaint(SingleOutputGraphNode[types.AudioRef], GraphNode[types.AudioRef]):
    """
    ...
    EndTimeRelativeTo: typing.ClassVar[type] = nodetool.nodes.fal.audio_to_audio.AceStepAudioInpaint.EndTimeRelativeTo
    Scheduler: typing.ClassVar[type] = nodetool.nodes.fal.audio_to_audio.AceStepAudioInpaint.Scheduler
    GuidanceType: typing.ClassVar[type] = nodetool.nodes.fal.audio_to_audio.AceStepAudioInpaint.GuidanceType
    StartTimeRelativeTo: typing.ClassVar[type] = nodetool.nodes.fal.audio_to_audio.AceStepAudioInpaint.StartTimeRelativeTo

    number_of_steps: int | OutputHandle[int] = connect_field(default=27, description='Number of steps to generate the audio.')
    start_time: float | OutputHandle[float] = connect_field(default=0, description='start time in seconds for the inpainting process.')
    ...
    end_time_relative_to: nodetool.nodes.fal.audio_to_audio.AceStepAudioInpaint.EndTimeRelativeTo = Field(default=nodetool.nodes.fal.audio_to_audio.AceStepAudioInpaint.EndTimeRelativeTo.START, description='Whether the end time is relative to the start or end of the audio.')
    tag_guidance_scale: float | OutputHandle[float] = connect_field(default=5, description='Tag guidance scale for the generation.')
    scheduler: nodetool.nodes.fal.audio_to_audio.AceStepAudioInpaint.Scheduler = Field(default=nodetool.nodes.fal.audio_to_audio.AceStepAudioInpaint.Scheduler.EULER, description='Scheduler to use for the generation process.')
    end_time: float | OutputHandle[float] = connect_field(default=30, description='end time in seconds for the inpainting process.')
    guidance_type: nodetool.nodes.fal.audio_to_audio.AceStepAudioInpaint.GuidanceType = Field(default=nodetool.nodes.fal.audio_to_audio.AceStepAudioInpaint.GuidanceType.APG, description='Type of CFG to use for the generation process.')
    ...
    variance: float | OutputHandle[float] = connect_field(default=0.5, description='Variance for the inpainting process. Higher values can lead to more diverse results.')
    ...
    start_time_relative_to: nodetool.nodes.fal.audio_to_audio.AceStepAudioInpaint.StartTimeRelativeTo = Field(default=nodetool.nodes.fal.audio_to_audio.AceStepAudioInpaint.StartTimeRelativeTo.START, description='Whether the start time is relative to the start or end of the audio.')
    audio: types.AudioRef | OutputHandle[types.AudioRef] = connect_field(default=types.AudioRef(type='audio', uri='', asset_id=None, data=None, metadata=None), description='URL of the audio file to be inpainted.')
...
class AceStepAudioOutpaint(SingleOutputGraphNode[types.AudioRef], GraphNode[types.AudioRef]):
    """
    ...
    Scheduler: typing.ClassVar[type] = nodetool.nodes.fal.audio_to_audio.AceStepAudioOutpaint.Scheduler
    GuidanceType: typing.ClassVar[type] = nodetool.nodes.fal.audio_to_audio.AceStepAudioOutpaint.GuidanceType

    number_of_steps: int | OutputHandle[int] = connect_field(default=27, description='Number of steps to generate the audio.')
    tags: str | OutputHandle[str] = connect_field(default='', description='Comma-separated list of genre tags to control the style of the generated audio.')
    minimum_guidance_scale: float | OutputHandle[float] = connect_field(default=3, description='Minimum guidance scale for the generation after the decay.')
    extend_after_duration: float | OutputHandle[float] = connect_field(default=30, description='Duration in seconds to extend the audio from the end.')
    lyrics: str | OutputHandle[str] = connect_field(default='', description='Lyrics to be sung in the audio. If not provided or if [inst] or [instrumental] is the content of this field, no lyrics will be sung. Use control structures like [verse], [chorus] and [bridge] to control the structure of the song.')
    tag_guidance_scale: float | OutputHandle[float] = connect_field(default=5, description='Tag guidance scale for the generation.')
    scheduler: nodetool.nodes.fal.audio_to_audio.AceStepAudioOutpaint.Scheduler = Field(default=nodetool.nodes.fal.audio_to_audio.AceStepAudioOutpaint.Scheduler.EULER, description='Scheduler to use for the generation process.')
    extend_before_duration: float | OutputHandle[float] = connect_field(default=0, description='Duration in seconds to extend the audio from the start.')
    guidance_type: nodetool.nodes.fal.audio_to_audio.AceStepAudioOutpaint.GuidanceType = Field(default=nodetool.nodes.fal.audio_to_audio.AceStepAudioOutpaint.GuidanceType.APG, description='Type of CFG to use for the generation process.')
    guidance_scale: float | OutputHandle[float] = connect_field(default=15, description='Guidance scale for the generation.')
    lyric_guidance_scale: float | OutputHandle[float] = connect_field(default=1.5, description='Lyric guidance scale for the generation.')
    guidance_interval: float | OutputHandle[float] = connect_field(default=0.5, description='Guidance interval for the generation. 0.5 means only apply guidance in the middle steps (0.25 * infer_steps to 0.75 * infer_steps)')
    guidance_interval_decay: float | OutputHandle[float] = connect_field(default=0, description='Guidance interval decay for the generation. Guidance scale will decay from guidance_scale to min_guidance_scale in the interval. 0.0 means no decay.')
    audio: types.AudioRef | OutputHandle[types.AudioRef] = connect_field(default=types.AudioRef(type='audio', uri='', asset_id=None, data=None, metadata=None), description='URL of the audio file to be outpainted.')
    seed: int | OutputHandle[int] = connect_field(default=-1, description='Random seed for reproducibility. If not provided, a random seed will be used.')
    granularity_scale: int | OutputHandle[int] = connect_field(default=10, description='Granularity scale for the generation process. Higher values can reduce artifacts.')
...
class AceStepAudioToAudio(SingleOutputGraphNode[types.AudioRef], GraphNode[types.AudioRef]):
    """
    ...
    Scheduler: typing.ClassVar[type] = nodetool.nodes.fal.audio_to_audio.AceStepAudioToAudio.Scheduler
    GuidanceType: typing.ClassVar[type] = nodetool.nodes.fal.audio_to_audio.AceStepAudioToAudio.GuidanceType
    EditMode: typing.ClassVar[type] = nodetool.nodes.fal.audio_to_audio.AceStepAudioToAudio.EditMode
    ...
    lyrics: str | OutputHandle[str] = connect_field(default='', description='Lyrics to be sung in the audio. If not provided or if [inst] or [instrumental] is the content of this field, no lyrics will be sung. Use control structures like [verse], [chorus] and [bridge] to control the structure of the song.')
    tag_guidance_scale: float | OutputHandle[float] = connect_field(default=5, description='Tag guidance scale for the generation.')
    original_lyrics: str | OutputHandle[str] = connect_field(default='', description='Original lyrics of the audio file.')
    scheduler: nodetool.nodes.fal.audio_to_audio.AceStepAudioToAudio.Scheduler = Field(default=nodetool.nodes.fal.audio_to_audio.AceStepAudioToAudio.Scheduler.EULER, description='Scheduler to use for the generation process.')
    guidance_scale: float | OutputHandle[float] = connect_field(default=15, description='Guidance scale for the generation.')
    guidance_type: nodetool.nodes.fal.audio_to_audio.AceStepAudioToAudio.GuidanceType = Field(default=nodetool.nodes.fal.audio_to_audio.AceStepAudioToAudio.GuidanceType.APG, description='Type of CFG to use for the generation process.')
    lyric_guidance_scale: float | OutputHandle[float] = connect_field(default=1.5, description='Lyric guidance scale for the generation.')
    guidance_interval: float | OutputHandle[float] = connect_field(default=0.5, description='Guidance interval for the generation. 0.5 means only apply guidance in the middle steps (0.25 * infer_steps to 0.75 * infer_steps)')
    edit_mode: nodetool.nodes.fal.audio_to_audio.AceStepAudioToAudio.EditMode = Field(default=nodetool.nodes.fal.audio_to_audio.AceStepAudioToAudio.EditMode.REMIX, description='Whether to edit the lyrics only or remix the audio.')
    guidance_interval_decay: float | OutputHandle[float] = connect_field(default=0, description='Guidance interval decay for the generation. Guidance scale will decay from guidance_scale to min_guidance_scale in the interval. 0.0 means no decay.')
    audio: types.AudioRef | OutputHandle[types.AudioRef] = connect_field(default=types.AudioRef(type='audio', uri='', asset_id=None, data=None, metadata=None), description='URL of the audio file to be outpainted.')
    seed: int | OutputHandle[int] = connect_field(default=-1, description='Random seed for reproducibility. If not provided, a random seed will be used.')
    granularity_scale: int | OutputHandle[int] = connect_field(default=10, description='Granularity scale for the generation process. Higher values can reduce artifacts.')
    original_tags: str | OutputHandle[str] = connect_field(default='', description='Original tags of the audio file.')
    original_seed: int | OutputHandle[int] = connect_field(default=-1, description='Original seed of the audio file.')
...
class AudioUnderstanding(SingleOutputGraphNode[Any], GraphNode[Any]):
    ...
    prompt: str | OutputHandle[str] = connect_field(default='', description='The question or prompt about the audio content.')
    detailed_analysis: bool | OutputHandle[bool] = connect_field(default=False, description='Whether to request a more detailed analysis of the audio')
    audio: types.AudioRef | OutputHandle[types.AudioRef] = connect_field(default=types.AudioRef(type='audio', uri='', asset_id=None, data=None, metadata=None), description='URL of the audio file to analyze')
...
class Deepfilternet3(SingleOutputGraphNode[dict[str, Any]], GraphNode[dict[str, Any]]):
    ...
    audio: types.AudioRef | OutputHandle[types.AudioRef] = connect_field(default=types.AudioRef(type='audio', uri='', asset_id=None, data=None, metadata=None), description='The URL of the audio to enhance.')
...
class Demucs(SingleOutputGraphNode[dict[str, Any]], GraphNode[dict[str, Any]]):
    ...
    audio: types.AudioRef | OutputHandle[types.AudioRef] = connect_field(default=types.AudioRef(type='audio', uri='', asset_id=None, data=None, metadata=None), description='URL of the audio file to separate into stems')
...
class DiaTtsVoiceClone(SingleOutputGraphNode[types.AudioRef], GraphNode[types.AudioRef]):
    """
    ...
    ref_text: str | OutputHandle[str] = connect_field(default='', description='The reference text to be used for TTS.')
...
class ElevenlabsAudioIsolation(SingleOutputGraphNode[types.AudioRef], GraphNode[types.AudioRef]):
    ...
    video: types.VideoRef | OutputHandle[types.VideoRef] = connect_field(default=types.VideoRef(type='video', uri='', asset_id=None, data=None, metadata=None, duration=None, format=None), description='Video file to use for audio isolation. Either `audio_url` or `video_url` must be provided.')
    audio: types.AudioRef | OutputHandle[types.AudioRef] = connect_field(default=types.AudioRef(type='audio', uri='', asset_id=None, data=None, metadata=None), description='URL of the audio file to isolate voice from')
...
class ElevenlabsVoiceChanger(SingleOutputGraphNode[types.AudioRef], GraphNode[types.AudioRef]):
    ...
    audio: types.AudioRef | OutputHandle[types.AudioRef] = connect_field(default=types.AudioRef(type='audio', uri='', asset_id=None, data=None, metadata=None), description='The input audio file')
...
class FfmpegApiMergeAudios(SingleOutputGraphNode[types.AudioRef], GraphNode[types.AudioRef]):
    ...
    audios: list[str] | OutputHandle[list[str]] = connect_field(default=[], description='List of audio URLs to merge in order. The 0th stream of the audio will be considered as the merge candidate.')
...
class KlingVideoCreateVoice(SingleOutputGraphNode[Any], GraphNode[Any]):
    ...
    voice: types.VideoRef | OutputHandle[types.VideoRef] = connect_field(default=types.VideoRef(type='video', uri='', asset_id=None, data=None, metadata=None, duration=None, format=None), description='URL of the voice audio file. Supports .mp3/.wav audio or .mp4/.mov video. Duration must be 5-30 seconds with clean, single-voice audio.')
...
class NovaSr(SingleOutputGraphNode[types.AudioRef], GraphNode[types.AudioRef]):
    ...
    audio: types.AudioRef | OutputHandle[types.AudioRef] = connect_field(default=types.AudioRef(type='audio', uri='', asset_id=None, data=None, metadata=None), description='The URL of the audio file to enhance.')
    bitrate: str | OutputHandle[str] = connect_field(default='192k', description='The bitrate of the output audio.')
...
class SamAudioSeparate(SingleOutputGraphNode[dict[str, Any]], GraphNode[dict[str, Any]]):
    ...
    audio: types.AudioRef | OutputHandle[types.AudioRef] = connect_field(default=types.AudioRef(type='audio', uri='', asset_id=None, data=None, metadata=None), description='URL of the audio file to process (WAV, MP3, FLAC supported)')
...
class SamAudioSpanSeparate(SingleOutputGraphNode[dict[str, Any]], GraphNode[dict[str, Any]]):
    ...
    audio: types.AudioRef | OutputHandle[types.AudioRef] = connect_field(default=types.AudioRef(type='audio', uri='', asset_id=None, data=None, metadata=None), description='URL of the audio file to process.')
...
class SonautoV2Extend(SingleOutputGraphNode[types.AudioRef], GraphNode[types.AudioRef]):
    ...
    OutputFormat: typing.ClassVar[type] = nodetool.nodes.fal.audio_to_audio.SonautoV2Extend.OutputFormat
    ...
    prompt_strength: float | OutputHandle[float] = connect_field(default=1.8, description='Controls how strongly your prompt influences the output. Greater values adhere more to the prompt but sound less natural. (This is CFG.)')
    ...
    output_format: nodetool.nodes.fal.audio_to_audio.SonautoV2Extend.OutputFormat = Field(default=nodetool.nodes.fal.audio_to_audio.SonautoV2Extend.OutputFormat.WAV, description=None)
    side: nodetool.nodes.fal.audio_to_audio.SonautoV2Extend.Side = Field(default=nodetool.nodes.fal.audio_to_audio.SonautoV2Extend.Side(''), description='Add more to the beginning (left) or end (right) of the song')
    ...
    crop_duration: float | OutputHandle[float] = connect_field(default=0, description='Duration in seconds to crop from the selected side before extending from that side.')
    ...
    extend_duration: str | OutputHandle[str] = connect_field(default='', description='Duration in seconds to extend the song. If not provided, will attempt to automatically determine.')
...
class StableAudio25AudioToAudio(SingleOutputGraphNode[types.AudioRef], GraphNode[types.AudioRef]):
    ...
    sync_mode: bool | OutputHandle[bool] = connect_field(default=False, description="If `True`, the media will be returned as a data URI and the output data won't be available in the request history.")
    audio: types.AudioRef | OutputHandle[types.AudioRef] = connect_field(default=types.AudioRef(type='audio', uri='', asset_id=None, data=None, metadata=None), description='The audio clip to transform')
...
class StableAudio25Inpaint(SingleOutputGraphNode[types.AudioRef], GraphNode[types.AudioRef]):
    """
    ...
    prompt: str | OutputHandle[str] = connect_field(default='', description='The prompt to guide the audio generation')
    guidance_scale: int | OutputHandle[int] = connect_field(default=1, description='How strictly the diffusion process adheres to the prompt text (higher values make your audio closer to your prompt).')
    mask_end: int | OutputHandle[int] = connect_field(default=190, description='The end point of the audio mask')
    sync_mode: bool | OutputHandle[bool] = connect_field(default=False, description="If `True`, the media will be returned as a data URI and the output data won't be available in the request history.")
    audio: types.AudioRef | OutputHandle[types.AudioRef] = connect_field(default=types.AudioRef(type='audio', uri='', asset_id=None, data=None, metadata=None), description='The audio clip to inpaint')
    seed: int | OutputHandle[int] = connect_field(default=0, description=None)
    seconds_total: int | OutputHandle[int] = connect_field(default=190, description='The duration of the audio clip to generate. If not provided, it will be set to the duration of the input audio.')
    num_inference_steps: int | OutputHandle[int] = connect_field(default=8, description='The number of steps to denoise the audio for')
    mask_start: int | OutputHandle[int] = connect_field(default=30, description='The start point of the audio mask')
