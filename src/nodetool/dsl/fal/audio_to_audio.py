...
class AceStepAudioInpaint(SingleOutputGraphNode[types.AudioRef], GraphNode[types.AudioRef]):
    ...
    audio_url: types.AudioRef | OutputHandle[types.AudioRef] = connect_field(default=types.AudioRef(type='audio', uri='', asset_id=None, data=None, metadata=None), description='URL of the audio file to be inpainted.')
...
class AceStepAudioOutpaint(SingleOutputGraphNode[types.AudioRef], GraphNode[types.AudioRef]):
    ...
    guidance_interval: float | OutputHandle[float] = connect_field(default=0.5, description='Guidance interval for the generation. 0.5 means only apply guidance in the middle steps (0.25 * infer_steps to 0.75 * infer_steps)')
    guidance_interval_decay: float | OutputHandle[float] = connect_field(default=0, description='Guidance interval decay for the generation. Guidance scale will decay from guidance_scale to min_guidance_scale in the interval. 0.0 means no decay.')
    audio_url: types.AudioRef | OutputHandle[types.AudioRef] = connect_field(default=types.AudioRef(type='audio', uri='', asset_id=None, data=None, metadata=None), description='URL of the audio file to be outpainted.')
    seed: int | OutputHandle[int] = connect_field(default=-1, description='Random seed for reproducibility. If not provided, a random seed will be used.')
    granularity_scale: int | OutputHandle[int] = connect_field(default=10, description='Granularity scale for the generation process. Higher values can reduce artifacts.')
...
class AudioUnderstanding(SingleOutputGraphNode[Any], GraphNode[Any]):
    ...
    audio_url: types.AudioRef | OutputHandle[types.AudioRef] = connect_field(default=types.AudioRef(type='audio', uri='', asset_id=None, data=None, metadata=None), description='URL of the audio file to analyze')
...
class ElevenlabsAudioIsolation(SingleOutputGraphNode[types.AudioRef], GraphNode[types.AudioRef]):
    ...
    video_url: types.VideoRef | OutputHandle[types.VideoRef] = connect_field(default=types.VideoRef(type='video', uri='', asset_id=None, data=None, metadata=None, duration=None, format=None), description='Video file to use for audio isolation. Either `audio_url` or `video_url` must be provided.')
    audio_url: types.AudioRef | OutputHandle[types.AudioRef] = connect_field(default=types.AudioRef(type='audio', uri='', asset_id=None, data=None, metadata=None), description='URL of the audio file to isolate voice from')
...
class KlingVideoCreateVoice(SingleOutputGraphNode[Any], GraphNode[Any]):
    ...
    voice_url: types.VideoRef | OutputHandle[types.VideoRef] = connect_field(default=types.VideoRef(type='video', uri='', asset_id=None, data=None, metadata=None, duration=None, format=None), description='URL of the voice audio file. Supports .mp3/.wav audio or .mp4/.mov video. Duration must be 5-30 seconds with clean, single-voice audio.')
...
class StableAudio25Inpaint(SingleOutputGraphNode[types.AudioRef], GraphNode[types.AudioRef]):
    ...
    sync_mode: bool | OutputHandle[bool] = connect_field(default=False, description="If `True`, the media will be returned as a data URI and the output data won't be available in the request history.")
    audio_url: types.AudioRef | OutputHandle[types.AudioRef] = connect_field(default=types.AudioRef(type='audio', uri='', asset_id=None, data=None, metadata=None), description='The audio clip to inpaint')
    seed: int | OutputHandle[int] = connect_field(default=0, description=None)
