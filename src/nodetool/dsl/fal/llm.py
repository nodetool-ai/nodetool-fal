...
class VideoPromptGenerator(SingleOutputGraphNode[Any], GraphNode[Any]):
    ...
    image: types.ImageRef | OutputHandle[types.ImageRef] = connect_field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None, metadata=None), description='URL of an image to analyze and incorporate into the video prompt (optional)')
