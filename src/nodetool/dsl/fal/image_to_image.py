...
class BriaBackgroundRemove(GraphNode):
    ...
    def get_node_type(cls):
        return "fal.image_to_image.BriaBackgroundRemove"
...
class BriaBackgroundReplace(GraphNode):
    ...
    ref_image: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(
        default=types.ImageRef(type="image", uri="", asset_id=None, data=None),
    ...
    refine_prompt: bool | GraphNode | tuple[GraphNode, str] = Field(
    ...
    @classmethod
    def get_node_type(cls):
        return "fal.image_to_image.BriaBackgroundReplace"
...
class BriaEraser(GraphNode):
    ...
    mask_type: str | GraphNode | tuple[GraphNode, str] = Field(
        default="manual",
    ...
    @classmethod
    def get_node_type(cls):
        return "fal.image_to_image.BriaEraser"
...
class BriaExpand(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "fal.image_to_image.BriaExpand"
...
class BriaGenFill(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "fal.image_to_image.BriaGenFill"
...
class BriaProductShot(GraphNode):
    ...
    scene_description: str | GraphNode | tuple[GraphNode, str] = Field(
    ...
    optimize_description: bool | GraphNode | tuple[GraphNode, str] = Field(
        default=True, description="Whether to optimize the scene description"
    )
    placement_type: str | GraphNode | tuple[GraphNode, str] = Field(
        default="manual_placement",
        description="How to position the product (original, automatic, manual_placement, manual_padding)",
    )
    manual_placement_selection: str | GraphNode | tuple[GraphNode, str] = Field(
...
class FluxDevRedux(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "fal.image_to_image.FluxDevRedux"
...
class FluxLoraCanny(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "fal.image_to_image.FluxLoraCanny"
...
class FluxLoraDepth(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "fal.image_to_image.FluxLoraDepth"
...
class FluxProCanny(GraphNode):
    ...
    safety_tolerance: str | GraphNode | tuple[GraphNode, str] = Field(
        default="2", description="Safety tolerance level (1-6, 1 being most strict)"
    )

    @classmethod
    def get_node_type(cls):
        return "fal.image_to_image.FluxProCanny"
...
class FluxProDepth(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "fal.image_to_image.FluxProDepth"
...
class FluxProFill(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "fal.image_to_image.FluxProFill"
...
class FluxProRedux(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "fal.image_to_image.FluxProRedux"
...
class FluxProUltraRedux(GraphNode):
    ...
    image_prompt_strength: float | GraphNode | tuple[GraphNode, str] = Field(
        default=0.1, description="The strength of the image prompt, between 0 and 1"
    )

    @classmethod
    def get_node_type(cls):
        return "fal.image_to_image.FluxProUltraRedux"
...
class FluxSchnellRedux(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "fal.image_to_image.FluxSchnellRedux"
...
class IdeogramV2Edit(GraphNode):
    ...
    style: str | GraphNode | tuple[GraphNode, str] = Field(
        default="auto",
    ...
    @classmethod
    def get_node_type(cls):
        return "fal.image_to_image.IdeogramV2Edit"
