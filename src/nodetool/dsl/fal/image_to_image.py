...
class BenV2Image(SingleOutputGraphNode[dict[str, Any]], GraphNode[dict[str, Any]]):
    ...
    image_url: types.ImageRef | OutputHandle[types.ImageRef] = connect_field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None, metadata=None), description='URL of image to be used for background removal')
...
class BriaProductShot(SingleOutputGraphNode[types.ImageRef], GraphNode[types.ImageRef]):
    ...
    image_url: types.ImageRef | OutputHandle[types.ImageRef] = connect_field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None, metadata=None), description='The URL of the product shot to be placed in a lifestyle shot. If both image_url and image_file are provided, image_url will be used. Accepted formats are jpeg, jpg, png, webp. Maximum file size 12MB.')
...
class Cartoonify(SingleOutputGraphNode[types.ImageRef], GraphNode[types.ImageRef]):
    ...
    image_url: types.ImageRef | OutputHandle[types.ImageRef] = connect_field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None, metadata=None), description='URL of the image to apply Pixar style to')
...
class CatVton(SingleOutputGraphNode[types.ImageRef], GraphNode[types.ImageRef]):
    ...
    garment_image_url: types.ImageRef | OutputHandle[types.ImageRef] = connect_field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None, metadata=None), description='Url to the garment image.')
    image_size: str | OutputHandle[str] = connect_field(default='portrait_4_3', description='The size of the generated image.')
    human_image_url: types.ImageRef | OutputHandle[types.ImageRef] = connect_field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None, metadata=None), description='Url for the human image.')
...
class ChainOfZoom(SingleOutputGraphNode[types.ImageRef], GraphNode[types.ImageRef]):
    ...
    image_url: types.ImageRef | OutputHandle[types.ImageRef] = connect_field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None, metadata=None), description='Input image to zoom into')
...
class Esrgan(SingleOutputGraphNode[types.ImageRef], GraphNode[types.ImageRef]):
    ...
    image_url: types.ImageRef | OutputHandle[types.ImageRef] = connect_field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None, metadata=None), description='Url to input image')
...
class FaceToSticker(SingleOutputGraphNode[types.ImageRef], GraphNode[types.ImageRef]):
    ...
    image_url: types.ImageRef | OutputHandle[types.ImageRef] = connect_field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None, metadata=None), description='URL of the video.')
...
class FastSdxlControlnetCannyImageToImage(SingleOutputGraphNode[types.ImageRef], GraphNode[types.ImageRef]):
    ...
    strength: float | OutputHandle[float] = connect_field(default=0.95, description='determines how much the generated image resembles the initial image')
    sync_mode: bool | OutputHandle[bool] = connect_field(default=False, description='If set to true, the function will wait for the image to be generated and uploaded before returning the response. This will increase the latency of the function but it allows you to get the image directly in the response without going through the CDN.')
    control_image_url: types.ImageRef | OutputHandle[types.ImageRef] = connect_field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None, metadata=None), description='The URL of the control image.')
...
class FinegrainEraserMask(SingleOutputGraphNode[dict[str, Any]], GraphNode[dict[str, Any]]):
    ...
    seed: int | OutputHandle[int] = connect_field(default=-1, description='Random seed for reproducible generation')
    mask_url: types.ImageRef | OutputHandle[types.ImageRef] = connect_field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None, metadata=None), description='URL of the mask image. Should be a binary mask where white (255) indicates areas to erase')
    image_url: types.ImageRef | OutputHandle[types.ImageRef] = connect_field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None, metadata=None), description='URL of the image to edit')
...
class FluxDifferentialDiffusion(SingleOutputGraphNode[types.ImageRef], GraphNode[types.ImageRef]):
    ...
    prompt: str | OutputHandle[str] = connect_field(default='', description='The prompt to generate an image from.')
    num_images: int | OutputHandle[int] = connect_field(default=1, description='The number of images to generate.')
    image_url: types.ImageRef | OutputHandle[types.ImageRef] = connect_field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None, metadata=None), description='URL of image to use as initial image.')
    sync_mode: bool | OutputHandle[bool] = connect_field(default=False, description="If `True`, the media will be returned as a data URI and the output data won't be available in the request history.")
...
class FluxGeneralRfInversion(SingleOutputGraphNode[types.ImageRef], GraphNode[types.ImageRef]):
    ...
    seed: int | OutputHandle[int] = connect_field(default=-1, description='The same seed and the same prompt given to the same version of the model will output the same image every time.')
    image_url: types.ImageRef | OutputHandle[types.ImageRef] = connect_field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None, metadata=None), description='URL of image to be edited')
    fill_image: str | OutputHandle[str] = connect_field(default='', description='Use an image input to influence the generation. Can be used to fill images in masked areas.')
    nag_scale: float | OutputHandle[float] = connect_field(default=3, description='The scale for NAG. Higher values will result in a image that is more distant to the negative prompt.')
...
class FluxLoraFill(SingleOutputGraphNode[types.ImageRef], GraphNode[types.ImageRef]):
    ...
    image_url: types.ImageRef | OutputHandle[types.ImageRef] = connect_field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None, metadata=None), description='URL of image to use for fill operation')
    sync_mode: bool | OutputHandle[bool] = connect_field(default=False, description="If `True`, the media will be returned as a data URI and the output data won't be available in the request history.")
...
class FluxPulid(SingleOutputGraphNode[types.ImageRef], GraphNode[types.ImageRef]):
    ...
    reference_image_url: types.ImageRef | OutputHandle[types.ImageRef] = connect_field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None, metadata=None), description='URL of image to use for inpainting.')
    enable_safety_checker: bool | OutputHandle[bool] = connect_field(default=True, description='If set to true, the safety checker will be enabled.')
...
class GeminiFlashEdit(SingleOutputGraphNode[dict[str, Any]], GraphNode[dict[str, Any]]):
    ...
    image_url: types.ImageRef | OutputHandle[types.ImageRef] = connect_field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None, metadata=None), description='Optional URL of an input image for editing. If not provided, generates a new image.')
...
class GeminiFlashEditMulti(SingleOutputGraphNode[dict[str, Any]], GraphNode[dict[str, Any]]):
    ...
    prompt: str | OutputHandle[str] = connect_field(default='', description='The prompt for image generation or editing')
    input_image_urls: list[str] | OutputHandle[list[str]] = connect_field(default=[], description='List of URLs of input images for editing')
...
class IclightV2(SingleOutputGraphNode[types.ImageRef], GraphNode[types.ImageRef]):
    ...
    mask_image_url: types.ImageRef | OutputHandle[types.ImageRef] = connect_field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None, metadata=None), description='URL of mask to be used for ic-light conditioning image')
    guidance_scale: float | OutputHandle[float] = connect_field(default=5, description='The CFG (Classifier Free Guidance) scale is a measure of how close you want the model to stick to your prompt when looking for a related image to show you.')
...
class IdeogramUpscale(SingleOutputGraphNode[types.ImageRef], GraphNode[types.ImageRef]):
    ...
    image_url: types.ImageRef | OutputHandle[types.ImageRef] = connect_field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None, metadata=None), description='The image URL to upscale')
    sync_mode: bool | OutputHandle[bool] = connect_field(default=False, description="If `True`, the media will be returned as a data URI and the output data won't be available in the request history.")
    seed: str | OutputHandle[str] = connect_field(default='', description='Seed for the random number generator')
...
class Image2svg(SingleOutputGraphNode[types.ImageRef], GraphNode[types.ImageRef]):
    ...
    image_url: types.ImageRef | OutputHandle[types.ImageRef] = connect_field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None, metadata=None), description='The image to convert to SVG')
...
class ImageEditingBabyVersion(SingleOutputGraphNode[types.ImageRef], GraphNode[types.ImageRef]):
    ...
    image_url: types.ImageRef | OutputHandle[types.ImageRef] = connect_field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None, metadata=None), description='URL of the image to transform into a baby version.')
    sync_mode: bool | OutputHandle[bool] = connect_field(default=False, description="If `True`, the media will be returned as a data URI and the output data won't be available in the request history.")
...
class ImageEditingBroccoliHaircut(SingleOutputGraphNode[types.ImageRef], GraphNode[types.ImageRef]):
    ...
    image_url: types.ImageRef | OutputHandle[types.ImageRef] = connect_field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None, metadata=None), description='URL of the image to apply broccoli haircut style.')
    sync_mode: bool | OutputHandle[bool] = connect_field(default=False, description="If `True`, the media will be returned as a data URI and the output data won't be available in the request history.")
    guidance_scale: float | OutputHandle[float] = connect_field(default=3.5, description='The CFG (Classifier Free Guidance) scale is a measure of how close you want the model to stick to your prompt when looking for a related image to show you.')
    num_inference_steps: int | OutputHandle[int] = connect_field(default=30, description='Number of inference steps for sampling.')
    enable_safety_checker: bool | OutputHandle[bool] = connect_field(default=True, description='Whether to enable the safety checker for the generated image.')
...
class ImageEditingPhotoRestoration(SingleOutputGraphNode[types.ImageRef], GraphNode[types.ImageRef]):
    ...
    image_url: types.ImageRef | OutputHandle[types.ImageRef] = connect_field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None, metadata=None), description='URL of the old or damaged photo to restore.')
    sync_mode: bool | OutputHandle[bool] = connect_field(default=False, description="If `True`, the media will be returned as a data URI and the output data won't be available in the request history.")
...
class ImageEditingPlushieStyle(SingleOutputGraphNode[types.ImageRef], GraphNode[types.ImageRef]):
    ...
    lora_scale: float | OutputHandle[float] = connect_field(default=1, description='The scale factor for the LoRA model. Controls the strength of the LoRA effect.')
    image_url: types.ImageRef | OutputHandle[types.ImageRef] = connect_field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None, metadata=None), description='URL of the image to convert to plushie style.')
    sync_mode: bool | OutputHandle[bool] = connect_field(default=False, description="If `True`, the media will be returned as a data URI and the output data won't be available in the request history.")
    guidance_scale: float | OutputHandle[float] = connect_field(default=3.5, description='The CFG (Classifier Free Guidance) scale is a measure of how close you want the model to stick to your prompt when looking for a related image to show you.')
    num_inference_steps: int | OutputHandle[int] = connect_field(default=30, description='Number of inference steps for sampling.')
    enable_safety_checker: bool | OutputHandle[bool] = connect_field(default=True, description='Whether to enable the safety checker for the generated image.')
...
class ImageEditingTextRemoval(SingleOutputGraphNode[types.ImageRef], GraphNode[types.ImageRef]):
    ...
    image_url: types.ImageRef | OutputHandle[types.ImageRef] = connect_field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None, metadata=None), description='URL of the image containing text to be removed.')
    sync_mode: bool | OutputHandle[bool] = connect_field(default=False, description="If `True`, the media will be returned as a data URI and the output data won't be available in the request history.")
...
class ImageEditingWojakStyle(SingleOutputGraphNode[types.ImageRef], GraphNode[types.ImageRef]):
    ...
    lora_scale: float | OutputHandle[float] = connect_field(default=1, description='The scale factor for the LoRA model. Controls the strength of the LoRA effect.')
    image_url: types.ImageRef | OutputHandle[types.ImageRef] = connect_field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None, metadata=None), description='URL of the image to convert to wojak style.')
    sync_mode: bool | OutputHandle[bool] = connect_field(default=False, description="If `True`, the media will be returned as a data URI and the output data won't be available in the request history.")
    guidance_scale: float | OutputHandle[float] = connect_field(default=3.5, description='The CFG (Classifier Free Guidance) scale is a measure of how close you want the model to stick to your prompt when looking for a related image to show you.')
    num_inference_steps: int | OutputHandle[int] = connect_field(default=30, description='Number of inference steps for sampling.')
    enable_safety_checker: bool | OutputHandle[bool] = connect_field(default=True, description='Whether to enable the safety checker for the generated image.')
...
class ImageEditingYoutubeThumbnails(SingleOutputGraphNode[types.ImageRef], GraphNode[types.ImageRef]):
    ...
    image_url: types.ImageRef | OutputHandle[types.ImageRef] = connect_field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None, metadata=None), description='URL of the image to convert to YouTube thumbnail style.')
    sync_mode: bool | OutputHandle[bool] = connect_field(default=False, description="If `True`, the media will be returned as a data URI and the output data won't be available in the request history.")
    guidance_scale: float | OutputHandle[float] = connect_field(default=3.5, description='The CFG (Classifier Free Guidance) scale is a measure of how close you want the model to stick to your prompt when looking for a related image to show you.')
    num_inference_steps: int | OutputHandle[int] = connect_field(default=30, description='Number of inference steps for sampling.')
    seed: int | OutputHandle[int] = connect_field(default=-1, description='The same seed and the same prompt given to the same version of the model will output the same image every time.')
...
class ImagePreprocessorsDepthAnythingV2(SingleOutputGraphNode[types.ImageRef], GraphNode[types.ImageRef]):
    ...
    image_url: types.ImageRef | OutputHandle[types.ImageRef] = connect_field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None, metadata=None), description='URL of the image to process')
...
class Inpaint(SingleOutputGraphNode[dict[str, Any]], GraphNode[dict[str, Any]]):
    ...
    prompt: str | OutputHandle[str] = connect_field(default='', description='The prompt to use for generating the image. Be as descriptive as possible for best results.')
    image_url: types.ImageRef | OutputHandle[types.ImageRef] = connect_field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None, metadata=None), description='Input image for img2img or inpaint mode')
...
class InvisibleWatermark(SingleOutputGraphNode[dict[str, Any]], GraphNode[dict[str, Any]]):
    ...
    image_url: types.ImageRef | OutputHandle[types.ImageRef] = connect_field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None, metadata=None), description='URL of image to be watermarked or decoded')
...
class IpAdapterFaceId(SingleOutputGraphNode[dict[str, Any]], GraphNode[dict[str, Any]]):
    ...
    prompt: str | OutputHandle[str] = connect_field(default='', description='The prompt to use for generating the image. Be as descriptive as possible for best results.')
    face_image_url: types.ImageRef | OutputHandle[types.ImageRef] = connect_field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None, metadata=None), description='An image of a face to match. If an image with a size of 640x640 is not provided, it will be scaled and cropped to that size.')
...
class LcmSd15I2i(SingleOutputGraphNode[types.ImageRef], GraphNode[types.ImageRef]):
    ...
    image_url: types.ImageRef | OutputHandle[types.ImageRef] = connect_field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None, metadata=None), description='The image to use as a base.')
...
class LeffaPoseTransfer(SingleOutputGraphNode[dict[str, Any]], GraphNode[dict[str, Any]]):
    ...
    pose_image_url: types.ImageRef | OutputHandle[types.ImageRef] = connect_field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None, metadata=None), description='Url for the human image.')
    ...
    seed: int | OutputHandle[int] = connect_field(default=-1, description='The same seed and the same input given to the same version of the model will output the same image every time.')
    enable_safety_checker: bool | OutputHandle[bool] = connect_field(default=True, description='If set to true, the safety checker will be enabled.')
    person_image_url: types.ImageRef | OutputHandle[types.ImageRef] = connect_field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None, metadata=None), description='Url to the garment image.')
...
class LivePortraitImage(SingleOutputGraphNode[types.ImageRef], GraphNode[types.ImageRef]):
    ...
    image_url: types.ImageRef | OutputHandle[types.ImageRef] = connect_field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None, metadata=None), description='URL of the image to be animated')
...
class LoraImageToImage(SingleOutputGraphNode[types.ImageRef], GraphNode[types.ImageRef]):
    ...
    image_url: types.ImageRef | OutputHandle[types.ImageRef] = connect_field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None, metadata=None), description='URL of image to use for image to image/inpainting.')
    ...
    seed: int | OutputHandle[int] = connect_field(default=-1, description='The same seed and the same prompt given to the same version of Stable Diffusion will output the same image every time.')
    ic_light_model_background_image_url: types.ImageRef | OutputHandle[types.ImageRef] = connect_field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None, metadata=None), description='The URL of the IC Light model background image to use for the image generation. Make sure to use a background compatible with the model.')
    ...
    ic_light_image_url: types.ImageRef | OutputHandle[types.ImageRef] = connect_field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None, metadata=None), description='The URL of the IC Light model image to use for the image generation.')
...
class LoraInpaint(SingleOutputGraphNode[types.ImageRef], GraphNode[types.ImageRef]):
    ...
    image_url: types.ImageRef | OutputHandle[types.ImageRef] = connect_field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None, metadata=None), description='URL of image to use for image to image/inpainting.')
    seed: int | OutputHandle[int] = connect_field(default=-1, description='The same seed and the same prompt given to the same version of Stable Diffusion will output the same image every time.')
    mask_url: types.ImageRef | OutputHandle[types.ImageRef] = connect_field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None, metadata=None), description='URL of black-and-white image to use as mask during inpainting.')
    image_encoder_subfolder: str | OutputHandle[str] = connect_field(default='', description='The subfolder of the image encoder model to use for the image generation.')
    ic_light_model_background_image_url: types.ImageRef | OutputHandle[types.ImageRef] = connect_field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None, metadata=None), description='The URL of the IC Light model background image to use for the image generation. Make sure to use a background compatible with the model.')
    rescale_betas_snr_zero: bool | OutputHandle[bool] = connect_field(default=False, description='Whether to set the rescale_betas_snr_zero option or not for the sampler')
    tile_width: int | OutputHandle[int] = connect_field(default=4096, description='The size of the tiles to be used for the image generation.')
...
class LumaPhotonFlashModify(SingleOutputGraphNode[types.ImageRef], GraphNode[types.ImageRef]):
    ...
    image_url: types.ImageRef | OutputHandle[types.ImageRef] = connect_field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None, metadata=None), description='URL of the input image to reframe')
...
class MixDehazeNet(SingleOutputGraphNode[types.ImageRef], GraphNode[types.ImageRef]):
    ...
    seed: int | OutputHandle[int] = connect_field(default=-1, description='seed to be used for generation')
    image_url: types.ImageRef | OutputHandle[types.ImageRef] = connect_field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None, metadata=None), description='URL of image to be used for image enhancement')
...
class ObjectRemovalMask(SingleOutputGraphNode[types.ImageRef], GraphNode[types.ImageRef]):
    ...
    mask_expansion: int | OutputHandle[int] = connect_field(default=15, description='Amount of pixels to expand the mask by. Range: 0-50')
    mask_url: types.ImageRef | OutputHandle[types.ImageRef] = connect_field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None, metadata=None), description='The URL of the mask image. White pixels (255) indicate areas to remove.')
    image_url: types.ImageRef | OutputHandle[types.ImageRef] = connect_field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None, metadata=None), description='The URL of the image to remove objects from.')
...
class OmniZero(SingleOutputGraphNode[types.ImageRef], GraphNode[types.ImageRef]):
    ...
    identity_image_url: types.ImageRef | OutputHandle[types.ImageRef] = connect_field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None, metadata=None), description='Identity image url.')
    ...
    composition_image_url: types.ImageRef | OutputHandle[types.ImageRef] = connect_field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None, metadata=None), description='Composition image url.')
    ...
    image_url: types.ImageRef | OutputHandle[types.ImageRef] = connect_field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None, metadata=None), description='Input image url.')
    style_image_url: types.ImageRef | OutputHandle[types.ImageRef] = connect_field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None, metadata=None), description='Style image url.')
...
class Pasd(SingleOutputGraphNode[types.ImageRef], GraphNode[types.ImageRef]):
    ...
    image_url: types.ImageRef | OutputHandle[types.ImageRef] = connect_field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None, metadata=None), description='Input image to super-resolve')
...
class Photomaker(SingleOutputGraphNode[types.ImageRef], GraphNode[types.ImageRef]):
    ...
    guidance_scale: float | OutputHandle[float] = connect_field(default=5, description='The CFG (Classifier Free Guidance) scale is a measure of how close you want the model to stick to your prompt when looking for a related image to show you.')
    seed: int | OutputHandle[int] = connect_field(default=-1, description='The same seed and the same prompt given to the same version of Stable Diffusion will output the same image every time.')
    image_archive_url: types.ImageRef | OutputHandle[types.ImageRef] = connect_field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None, metadata=None), description='The URL of the image archive containing the images you want to use.')
    initial_image_url: types.ImageRef | OutputHandle[types.ImageRef] = connect_field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None, metadata=None), description='Optional initial image for img2img')
...
class Plushify(SingleOutputGraphNode[types.ImageRef], GraphNode[types.ImageRef]):
    ...
    num_images: int | OutputHandle[int] = connect_field(default=1, description='Number of images to generate')
    use_cfg_zero: bool | OutputHandle[bool] = connect_field(default=False, description='Whether to use CFG zero')
    image_url: types.ImageRef | OutputHandle[types.ImageRef] = connect_field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None, metadata=None), description='URL of the image to apply cartoon style to')
...
class PostProcessing(SingleOutputGraphNode[types.ImageRef], GraphNode[types.ImageRef]):
    ...
    dissolve_image_url: types.ImageRef | OutputHandle[types.ImageRef] = connect_field(default='', description='URL of second image for dissolve')
...
class RecraftUpscaleCreative(SingleOutputGraphNode[types.ImageRef], GraphNode[types.ImageRef]):
    ...
    sync_mode: bool | OutputHandle[bool] = connect_field(default=False, description="If `True`, the media will be returned as a data URI and the output data won't be available in the request history.")
    enable_safety_checker: bool | OutputHandle[bool] = connect_field(default=False, description='If set to true, the safety checker will be enabled.')
    image_url: types.ImageRef | OutputHandle[types.ImageRef] = connect_field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None, metadata=None), description='The URL of the image to be upscaled. Must be in PNG format.')
...
class RecraftVectorize(SingleOutputGraphNode[types.ImageRef], GraphNode[types.ImageRef]):
    ...
    image_url: types.ImageRef | OutputHandle[types.ImageRef] = connect_field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None, metadata=None), description='The URL of the image to be vectorized. Must be in PNG, JPG or WEBP format, less than 5 MB in size, have resolution less than 16 MP and max dimension less than 4096 pixels, min dimension more than 256 pixels.')
...
class Retoucher(SingleOutputGraphNode[dict[str, Any]], GraphNode[dict[str, Any]]):
    ...
    image_url: types.ImageRef | OutputHandle[types.ImageRef] = connect_field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None, metadata=None), description='The URL of the image to be retouched.')
...
class Sam2AutoSegment(SingleOutputGraphNode[dict[str, Any]], GraphNode[dict[str, Any]]):
    ...
    image_url: types.ImageRef | OutputHandle[types.ImageRef] = connect_field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None, metadata=None), description='URL of the image to be automatically segmented')
    sync_mode: bool | OutputHandle[bool] = connect_field(default=False, description="If `True`, the media will be returned as a data URI and the output data won't be available in the request history.")
...
class SdxlControlnetUnionImageToImage(SingleOutputGraphNode[types.ImageRef], GraphNode[types.ImageRef]):
    ...
    request_id: str | OutputHandle[str] = connect_field(default='', description='An id bound to a request, can be used with response to identify the request itself.')
    seed: int | OutputHandle[int] = connect_field(default=-1, description='The same seed and the same prompt given to the same version of Stable Diffusion will output the same image every time.')
    segmentation_image_url: types.ImageRef | OutputHandle[types.ImageRef] = connect_field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None, metadata=None), description='The URL of the control image.')
    openpose_image_url: types.ImageRef | OutputHandle[types.ImageRef] = connect_field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None, metadata=None), description='The URL of the control image.')
    canny_preprocess: bool | OutputHandle[bool] = connect_field(default=True, description='Whether to preprocess the canny image.')
    expand_prompt: bool | OutputHandle[bool] = connect_field(default=False, description='If set to true, the prompt will be expanded with additional prompts.')
    depth_image_url: types.ImageRef | OutputHandle[types.ImageRef] = connect_field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None, metadata=None), description='The URL of the control image.')
...
class Thera(SingleOutputGraphNode[dict[str, Any]], GraphNode[dict[str, Any]]):
    ...
    image_url: types.ImageRef | OutputHandle[types.ImageRef] = connect_field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None, metadata=None), description='URL of image to be used for upscaling')
...
class Uno(SingleOutputGraphNode[types.ImageRef], GraphNode[types.ImageRef]):
    ...
    input_image_urls: list[str] | OutputHandle[list[str]] = connect_field(default=[], description='URL of images to use while generating the image.')
    sync_mode: bool | OutputHandle[bool] = connect_field(default=False, description='If set to true, the function will wait for the image to be generated and uploaded before returning the response. This will increase the latency of the function but it allows you to get the image directly in the response without going through the CDN.')
    guidance_scale: float | OutputHandle[float] = connect_field(default=3.5, description='The CFG (Classifier Free Guidance) scale is a measure of how close you want the model to stick to your prompt when looking for a related image to show you.')
    num_inference_steps: int | OutputHandle[int] = connect_field(default=28, description='The number of inference steps to perform.')
    seed: int | OutputHandle[int] = connect_field(default=-1, description='Random seed for reproducible generation. If set none, a random seed will be used.')
