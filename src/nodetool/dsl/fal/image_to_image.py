...
class KlingImageO3ImageToImage(SingleOutputGraphNode[types.ImageRef], GraphNode[types.ImageRef]):
    ...
    Resolution: typing.ClassVar[type] = nodetool.nodes.fal.image_to_image.KlingImageO3ImageToImage.Resolution
    KlingImageO3AspectRatio: typing.ClassVar[type] = nodetool.nodes.fal.image_to_image.KlingImageO3ImageToImage.KlingImageO3AspectRatio
    ResultType: typing.ClassVar[type] = nodetool.nodes.fal.image_to_image.KlingImageO3ImageToImage.ResultType
    OutputFormat: typing.ClassVar[type] = nodetool.nodes.fal.image_to_image.KlingImageO3ImageToImage.OutputFormat
    ...
    resolution: nodetool.nodes.fal.image_to_image.KlingImageO3ImageToImage.Resolution = Field(default=nodetool.nodes.fal.image_to_image.KlingImageO3ImageToImage.Resolution.VALUE_1K, description='Image generation resolution. 1K: standard, 2K: high-res, 4K: ultra high-res.')
    aspect_ratio: nodetool.nodes.fal.image_to_image.KlingImageO3ImageToImage.KlingImageO3AspectRatio = Field(default=nodetool.nodes.fal.image_to_image.KlingImageO3ImageToImage.KlingImageO3AspectRatio.AUTO, description="Aspect ratio of generated images. 'auto' intelligently determines based on input content.")
    ...
    result_type: nodetool.nodes.fal.image_to_image.KlingImageO3ImageToImage.ResultType = Field(default=nodetool.nodes.fal.image_to_image.KlingImageO3ImageToImage.ResultType.SINGLE, description="Result type. 'single' for one image, 'series' for a series of related images.")
    output_format: nodetool.nodes.fal.image_to_image.KlingImageO3ImageToImage.OutputFormat = Field(default=nodetool.nodes.fal.image_to_image.KlingImageO3ImageToImage.OutputFormat.PNG, description='The format of the generated image.')
    sync_mode: bool | OutputHandle[bool] = connect_field(default=False, description='If `True`, the media will be returned as a data URI.')
...
class NanoBanana2Edit(SingleOutputGraphNode[types.ImageRef], GraphNode[types.ImageRef]):
    ...
    Resolution: typing.ClassVar[type] = nodetool.nodes.fal.image_to_image.NanoBanana2Edit.Resolution
    AspectRatio: typing.ClassVar[type] = nodetool.nodes.fal.image_to_image.NanoBanana2Edit.AspectRatio
    OutputFormat: typing.ClassVar[type] = nodetool.nodes.fal.image_to_image.NanoBanana2Edit.OutputFormat
    SafetyTolerance: typing.ClassVar[type] = nodetool.nodes.fal.image_to_image.NanoBanana2Edit.SafetyTolerance

    prompt: str | OutputHandle[str] = connect_field(default='', description='The prompt for image editing.')
    images: list[types.ImageRef] | OutputHandle[list[types.ImageRef]] = connect_field(default=[], description='The images to use for image editing.')
    num_images: int | OutputHandle[int] = connect_field(default=1, description='The number of images to generate.')
    resolution: nodetool.nodes.fal.image_to_image.NanoBanana2Edit.Resolution = Field(default=nodetool.nodes.fal.image_to_image.NanoBanana2Edit.Resolution.VALUE_1K, description='The resolution of the image to generate.')
    aspect_ratio: nodetool.nodes.fal.image_to_image.NanoBanana2Edit.AspectRatio = Field(default=nodetool.nodes.fal.image_to_image.NanoBanana2Edit.AspectRatio.AUTO, description='The aspect ratio of the generated image.')
    output_format: nodetool.nodes.fal.image_to_image.NanoBanana2Edit.OutputFormat = Field(default=nodetool.nodes.fal.image_to_image.NanoBanana2Edit.OutputFormat.PNG, description='The format of the generated image.')
    sync_mode: bool | OutputHandle[bool] = connect_field(default=False, description="If `True`, the media will be returned as a data URI and the output data won't be available in the request history.")
    safety_tolerance: nodetool.nodes.fal.image_to_image.NanoBanana2Edit.SafetyTolerance = Field(default=nodetool.nodes.fal.image_to_image.NanoBanana2Edit.SafetyTolerance.VALUE_4, description='The safety tolerance level for content moderation. 1 is the most strict (blocks most content), 6 is the least strict.')
    ...
    limit_generations: bool | OutputHandle[bool] = connect_field(default=True, description='Experimental parameter to limit the number of generations from each round of prompting to 1.')
