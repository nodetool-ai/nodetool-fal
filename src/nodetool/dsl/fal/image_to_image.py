...
class FaceSwapImage(SingleOutputGraphNode[types.ImageRef], GraphNode[types.ImageRef]):
    ...
    target_image: types.ImageRef | OutputHandle[types.ImageRef] = connect_field(
        default=types.ImageRef(
            type="image", uri="", asset_id=None, data=None, metadata=None
        ),
...
class FluxDevRedux(SingleOutputGraphNode[types.ImageRef], GraphNode[types.ImageRef]):
    ...
    acceleration: str | OutputHandle[str] = connect_field(
        default="none", description="Acceleration speed: 'none', 'regular', or 'high'"
    )
