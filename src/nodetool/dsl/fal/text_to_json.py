...
class BriaFiboEditEditStructured_instruction(SingleOutputGraphNode[Any], GraphNode[Any]):
    ...
    mask: types.ImageRef | OutputHandle[types.ImageRef] = connect_field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None, metadata=None), description='Reference image mask (file or URL). Optional.')
