...
class OpenrouterRouterAudio(SingleOutputGraphNode[dict[str, Any]], GraphNode[dict[str, Any]]):
    ...
    audio: types.AudioRef | OutputHandle[types.AudioRef] = connect_field(default=types.AudioRef(type='audio', uri='', asset_id=None, data=None, metadata=None), description='URL or data URI of the audio file to process. Supported formats: wav, mp3, aiff, aac, ogg, flac, m4a.')
...
class Qwen3TtsCloneVoice06b(SingleOutputGraphNode[Any], GraphNode[Any]):
    ...
    audio: types.AudioRef | OutputHandle[types.AudioRef] = connect_field(default=types.AudioRef(type='audio', uri='', asset_id=None, data=None, metadata=None), description='URL to the reference audio file used for voice cloning.')
...
class WorkflowUtilitiesInterleaveVideo(SingleOutputGraphNode[types.VideoRef], GraphNode[types.VideoRef]):
    ...
    videos: list[str] | OutputHandle[list[str]] = connect_field(default=[], description='List of video URLs to interleave in order')
