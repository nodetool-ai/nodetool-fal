...
class MeshyV6PreviewTextTo3d(SingleOutputGraphNode[dict[str, Any]], GraphNode[dict[str, Any]]):
    ...
    texture_image_url: types.ImageRef | OutputHandle[types.ImageRef] = connect_field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None, metadata=None), description="2D image to guide the texturing process (only used in 'full' mode)")
