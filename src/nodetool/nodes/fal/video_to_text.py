...
class OpenrouterRouterVideoEnterprise(FALNode):
    ...
    videos: list[str] = Field(
        default=[], description="List of URLs or data URIs of video files to process. Supported formats: mp4, mpeg, mov, webm. For Google Gemini on AI Studio, YouTube links are also supported. Mutually exclusive with video_url."
    )
    ...
    def get_basic_fields(cls):
        return ["prompt", "videos", "system_prompt", "reasoning", "model"]
